...
# Index
  01. [Arrays & Hashing (Count = 5/9)](#01-arrays--hashing) 
  02. [Partition, 2 Pointers (Count = 3/5)](#02-partition-2-pointers) 
  03. [Binary Search (Count = 1/7)](#03-binary-search) 
  04. [Sliding Window (Count = 2/6)](#04-sliding-window) 
  05. [Intervals (Count = 2/6)](#05-intervals) 
  06. [Stack (Count = 0/7)](#06-stack) 
  07. [LinkedList (Count = 3/11)](#07-linkedlist) 
  08. [Trees (Count = 12/15)](#08-trees) 
  09. [Tries (Count = 0/3)](#09-tries) 
  10. [Backtracking (Count = 0/9)](#10-backtracking) 
  11. [Heap, Priority Queue (Count = 0/7)](#11-heap-priority-queue) 
  12. [Graphs (Count = 0/13)](#12-graphs)
  13. [1d Dynamic Programming (Count = 2/12)](#13-1d-dynamic-programming) 
  14. [Greedy (Count = 0/8)](#14-greedy) 
  15. [Advanced Graphs (Count = 0/6)](#15-advanced-graphs)
  16. [2d Dynamic Programming (Count = 0/11)](#16-2d-dynamic-programming) 
  17. [Bit Manipulation (Count = 5/7)](#17-bit-manipulation) 
  18. [Math & Geometry (Count = 4/8)](#18-math--geometry) 
...
| SNo | Problem# | Problem                                                                                                         | Solution | Notes | Similar Problems |
| --- | -------- | --------------------------------------------------------------------------------------------------------------- | -------- | ----- | ---------------- |
| ✅ 01  | 57       | [Insert Interval](https://leetcode.com/problems/insert-interval/)  | [C++](./c++/57-InsertInterval.cpp)  |       | 56,715,2276 |
